...
export default function FactorySection() {
  ...
  return (
    <section className="py-20 bg-gray-50 border-t border-b border-gray-200" id="factory-about-section">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        
        {/* Section Header */}
        <div className="text-left max-w-3xl mb-16">
          <div className="text-xs font-bold uppercase tracking-[0.2em] text-green-600 mb-3">Savoir-Faire Industriel</div>
        ...
        {/* Dynamic Interactive Stage Layout */}
        <div className="max-w-3xl mx-auto w-full">
          
          {/* Vertical Control steps list */}
              ...
              return (
                <div
                  ...
                  className={`p-8 rounded-2xl border transition-all cursor-pointer text-left ${
                    isSelected
                      ? 'bg-white border-green-600 shadow-xl'
                      : 'bg-white/40 border-gray-100 hover:border-gray-200 hover:bg-white'
                  }`}
                >
                  <div className="flex gap-6 items-start">
                    {/* Numéro de l'étape agrandi */}
                    <div className="text-lg font-bold tracking-widest text-green-600 font-sans mt-1">
                      {st.num}
                    </div>
                    
                    <div className="flex-grow">
                      {/* Titre agrandi (sans l'icône) */}
                      <h3 className="font-serif text-xl text-gray-900 flex items-center justify-between">
                        {st.title}
                      </h3>
                      
                      {/* Description plus lisible et aérée */}
                      <p className="text-gray-500 font-sans text-sm mt-3 leading-relaxed font-light">
                        {st.desc}
                      </p>
                    </div>
                  </div>
